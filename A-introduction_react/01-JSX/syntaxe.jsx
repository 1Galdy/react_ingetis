...
const toDoList = (
  ...
  const hello = <h1>Hello welcome to Ingetis</h1>;
    ...
    root.render(hello, document.getElementById('app3')); //Ceci ne fera rien :
  //C'est significatif ! Seule la mise à jour des éléments DOM nécessaires 
  // constitue une grande partie du succès de React. 
  // Ceci est accompli en utilisant le DOM virtuel de React .